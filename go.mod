...
// Keep this pin in sync with coder/coder's go.mod so this repo's tests run
// against the SDK that coder/coder actually ships.
replace github.com/charmbracelet/anthropic-sdk-go => github.com/coder/anthropic-sdk-go v0.0.0-20260428122333-47cab198e449

// coder/coder uses a fork of openai-go with deferred request body
// serialization and a WithJSONSet compatibility fix, rebased onto upstream
// v3.50.0. This tracks the coder/pinned branch; keep the pin in sync with
// coder/coder's go.mod.
